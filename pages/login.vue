    ...
    <section class="Form my-4 mx-5">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-5">
                    <img src="https://www.codeproject.com/KB/GDI-plus/ImageProcessing2/img.jpg" class="img-fluid">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="email" class="form-control my-3 p-4" placeholder="Email adress">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
